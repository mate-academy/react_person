...
- Open one more terminal and run tests with `npm test` to ensure your solution is correct.f
djdjdjdjdj
- Replace `<your_account>`     with your Github username in the [DEMO LINK](https://Ezero1.github.io/react_person/) and add it to the PR description.
