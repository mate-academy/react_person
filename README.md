...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://https://Vladimir-Zadorozhnyi.github.io/react_person/) and add it to the PR description.
