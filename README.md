...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://https://github.com/sapnachoudhary06/react_sum.git.github.io/react_person/) and add it to the PR description.
