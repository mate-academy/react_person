[DEMO LINK](https://artemvlasiuk.github.io/react_person/)
# React person
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://artemvlasiuk.github.io/react_person/) and add it to the PR description.
