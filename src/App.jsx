...
export const App = () => (
  <div className="App">
    ...
    <Person person={olya} />
    <Person person={alex} />
    {/* <Person name="Misha" age={37} isMarried="Natasha is my wife" />
    <Person name="Olya" isMarried="Maksym is my husband" />
    <Person name="Alex" age={25} isMarried="I am not married" />
